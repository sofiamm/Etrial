...
INSERT INTO etrial.categoria (id_categoria,descripcion,activo) VALUES 
('1','Monitores',    true), 
('2','Teclados',     true),
...
INSERT INTO etrial.articulo (id_articulo,id_categoria,descripcion,detalle,precio,existencias,activo) VALUES
...
INSERT INTO etrial.venta (id_venta,id_factura,id_articulo,precio,cantidad) values
(1,1,5,45000,3),
(2,1,9,15780,2),
(3,1,10,15000,3),
(4,2,5,45000,1),
